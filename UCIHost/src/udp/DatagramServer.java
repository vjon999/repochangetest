...
public class DatagramServer {
	...
	public void start() {
		...
		while(!exit) {
			try {
				...
				Thread reader = new Thread(new AsyncDatagramReader(p.getOutputStream(), datagramSocket, packet, infinite));
				Thread writer = new Thread(new AsyncDatagramWriter(p.getInputStream(), datagramSocket, packet.getAddress(), packet.getPort(), infinite));
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		DatagramServer server = new DatagramServer("C:/Users/Pratik/Desktop/Debug/Rybka_4_2/Deep Rybka 4 x64", DEFAULT_PORT);
		server.start();

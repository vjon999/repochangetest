...
<body onload="initDropdowns();">
	...
	<div class="center_bg1">
		<div class="lm_01">
			<span class="yavniHeader">Edit Organization: </span>${organization.organizationName}
		</div>
			...
			<form action="/mvc/su/saveOrganization" method="post">
				<table width="75%">
					<tr>
						...
						<td>
							<input name="organization" type="text" size="34" value="${organization.organizationName}" />
							<input type="hidden" name="organizationId" value="${organization.organizationId}" />
						</td>
					</tr>
					<tr>
						<td align="left" valign="top">Date</td>
						<td><input type="text" id="datepicker" name="date" value="${organization.campDate}" /></td>
					</tr>
					<tr>
						<td>Area</td>
						<td><input name="area" type="text" value="${organization.address.area}" /></td>
					</tr>
					<tr>
					...
					<tr>
						<td>Sectary Name :</td>
						<td><input name="secretaryName" type="text" value="${organization.secretaryName}" /></td>
					</tr>
					<tr>
						<td>Prisident Name.</td>
						<td><input name="presidentName" type="text" value="${organization.presidentName}" /></td>
					</tr>
					<tr>
						<td>Concerned Person Name</td>
						<td><input name="contactPerson" type="text" value="${organization.contactPerson}" /></td>
					</tr>
					<tr>
						<td>Address<strong> </strong></td>
						<td><textarea name="addressLine1" cols="32" rows="2" >${organization.address.addressLine1}</textarea></td>
					</tr>
					<tr>
						<td>Country</td>
					...
					<tr>
						<td>Pin</td>
						<td><input name="pin" type="text" size="6" maxlength="6" value="${organization.address.pin}" /></td>
					</tr>
					<tr>
						<td valign="top">Additional Comments <br /> (if any)
						</td>
						<td><textarea name="comments" rows="4" cols="33">${organization.comments}</textarea></td>
					</tr>
					<tr>
						<td colspan="2">
					...
					<tr align="center">
						<td valign="top" colspan="2"><input type="submit" value="Update" name="save" onclick="return chkFrm();" /> <input type="reset"
